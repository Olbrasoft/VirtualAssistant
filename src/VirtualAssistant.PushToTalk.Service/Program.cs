...
Console.WriteLine("Bluetooth mouse monitor started (LEFT=CapsLock, 2xLEFT=ESC, 2xRIGHT=Ctrl+C, MIDDLE=Enter)");
...
Console.WriteLine("USB mouse monitor started (LEFT=CapsLock, 2xLEFT=ESC, 2xRIGHT=Ctrl+C)");
