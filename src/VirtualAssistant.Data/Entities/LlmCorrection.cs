...
public class LlmCorrection
{
    ...
    /// <summary>
    /// Number of input/prompt tokens consumed by this correction.
    /// NULL for legacy corrections or providers that don't report usage.
    /// </summary>
    public int? InputTokens { get; set; }

    /// <summary>
    /// Number of output/completion tokens generated by this correction.
    /// NULL for legacy corrections or providers that don't report usage.
    /// </summary>
    public int? OutputTokens { get; set; }

    /// <summary>
    /// Number of reasoning tokens used (Mercury 2 specific).
    /// NULL for providers that don't use reasoning.
    /// </summary>
