...
namespace Olbrasoft.VirtualAssistant.Data.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20260502112430_RenameTtsKeyUsageByAccount")]
    partial class RenameTtsKeyUsageByAccount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Olbrasoft.VirtualAssistant.Data.Entities.LlmCorrection", b =>
                {
                    ...
                    b.Property<int>("VoiceTranscriptionId")
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("VoiceTranscriptionId");
            ...
            modelBuilder.Entity("Olbrasoft.VirtualAssistant.Data.Entities.ModelProviderMapping", b =>
                {
                    ...
                    b.ToTable("model_provider_mappings", (string)null);
            ...
            modelBuilder.Entity("Olbrasoft.VirtualAssistant.Data.Entities.Prompt", b =>
                {
                    ...
                    b.Property<string>("ApplicationPattern")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
            ...
            modelBuilder.Entity("Olbrasoft.VirtualAssistant.Data.Entities.TtsKeyUsage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("CounterMonth")
                        .HasColumnType("integer")
                        .HasColumnName("counter_month");

                    b.Property<int>("CounterYear")
                        .HasColumnType("integer")
                        .HasColumnName("counter_year");
                    ...
                    b.Property<DateTime?>("LastErrorUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_error_utc");

                    b.Property<DateTime?>("LastSuccessUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_success_utc");

                    b.Property<long>("MonthlyCharacterCount")
                    ...
                    b.Property<long>("TotalFailures")
                        .HasColumnType("bigint")
                        .HasColumnName("total_failures");

                    b.Property<long>("TotalSuccesses")
                        .HasColumnType("bigint")
                        .HasColumnName("total_successes");
                    ...
                    b.ToTable("tts_key_usage", (string)null);
                });
            ...
            modelBuilder.Entity("Olbrasoft.VirtualAssistant.Data.Entities.LlmCorrection", b =>
                {
                    b.HasOne("Olbrasoft.VirtualAssistant.Data.Entities.LlmModel", "Model")
                    ...
                    b.HasOne("Olbrasoft.VirtualAssistant.Data.Entities.VoiceTranscription", "VoiceTranscription")
                        .WithMany()
                        .HasForeignKey("VoiceTranscriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("VoiceTranscription");
                });
            ...
            modelBuilder.Entity("Olbrasoft.VirtualAssistant.Data.Entities.Notification", b =>
                {
                    ...
                    b.HasOne("Olbrasoft.VirtualAssistant.Data.Entities.LlmModel", "LlmModel")
                        .WithMany("Notifications")
                        .HasForeignKey("LlmModelId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Olbrasoft.VirtualAssistant.Data.Entities.Provider", "LlmProvider")
                        .WithMany("LlmNotifications")
            ...
            modelBuilder.Entity("Olbrasoft.VirtualAssistant.Data.Entities.Provider", b =>
                {
                    b.Navigation("LlmNotifications");

                    b.Navigation("ModelMappings");

                    b.Navigation("TtsAttempts");

                    b.Navigation("VoiceTranscriptions");
                });
