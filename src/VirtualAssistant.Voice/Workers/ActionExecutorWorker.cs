        ...
        try
        {
            switch (@event.Action)
            {
                ...
                case LlmRouterAction.Bash:
                    await _actionHandler.HandleOpenCodeAsync(@event.OriginalText, @event.PromptType, cancellationToken);
                    break;
                ...
                case LlmRouterAction.DispatchTask:
                    ...
                    {
                        await _actionHandler.HandleDispatchTaskAsync(@event.TargetAgent ?? "claude", cancellationToken);
                    }
                    break;
