...
/// Eliminates code duplication between ContinuousListenerWorker and ActionExecutorWorker.
/// </summary>
public class ActionHandlerService : IActionHandlerService
{
    ...
    /// <inheritdoc/>
    public async Task HandleOpenCodeActionAsync(string command, PromptType? promptType, CancellationToken cancellationToken)
    {
    ...
    /// <inheritdoc/>
    public void HandleRespondAction(string? response)
    {
    ...
    /// <inheritdoc/>
    public async Task HandleDispatchTaskActionAsync(string targetAgent, CancellationToken cancellationToken)
    {
