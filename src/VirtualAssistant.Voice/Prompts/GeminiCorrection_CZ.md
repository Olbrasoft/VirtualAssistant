...
- To je příkaz pro agentní program (Gemini CLI), který text od tebe dostane
...
## Gemini CLI Specifika

**Workflow:**
- Uživatel diktuje příkazy agentnímu programu Gemini CLI
...
- **Konfigurační soubor:** Gemini CLI pracuje se souborem **GEMINI.md** v kořenovém adresáři projektu
...
- Výstup se posílá do agentních programů (Gemini CLI) běžících v terminálu
